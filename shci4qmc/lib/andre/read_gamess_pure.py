...
import numpy as np
from shci4qmc.lib.andre.operator import mul
from shci4qmc.lib.andre.output_champ import *
from shci4qmc.lib.andre.parse_gamess import *
from functools import reduce

from shci4qmc.lib.andre.csf import *
...
with open(gamess_output_file, 'r') as gamess_file, open(gamess_input_file, 'r') as input_file:
	...
	print('DETS:')
	for n, det in enumerate(unique_dets):
		print('--------\n', n, det)
