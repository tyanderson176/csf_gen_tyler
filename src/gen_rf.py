...
if __name__ == "__main__":
    ...
    wf +=  0.1*Det([1, 2, 3, 4, 5], [1, 3])
    wf += -0.1*Det([1, 2, 3, 4, 5], [1, 4])

    g = CSF_Generator(wf, mol, mf, None)
    csfs = g.generate()
    ...
    print('Sigma plus part: ', g.ro_wf.real_part()) #zero
    print('Sigma minus part: ', g.ro_wf.imag_part()) #sum of csfs generated from g
